...
function AllUsers(){
        ...
        {field: "Actions",headerName: "Actions", flex: 1 ,headerAlign : 'center',renderCell:(params)=>{
            return(
                ...
                <div class="tooltip mx-1">
                    ...
                    <span class="tooltiptext" style={{fontSize: "12px",zIndex:1, width: "40px", marginLeft: "-20px;"}}>Éditer</span>
                </div>
                <div class="tooltip">
    ...
    const rows = [
        {id: 1, codeGRESA: 'equipement 1',nomDirecteur: 25, numeroTelephone: 20, nomEtablissement: 5},
    ]
    // function actions(){
    //     return(

    ...
    return (
            <div className="sidebar text-center hidden lg:block">
                <div className="top-menu">
                    <ul>
                        <li className="admin-front">
                            <div className="administrateur flex items-center" id="text">
                                <span className=' font-bold text-xl'>Admin</span>
                            </div>
                            <AiOutlineMenu size={30} color="white" onClick={handleMenu}/>
                        </li>
                        <li className="dashboard" id="text">
                            <Link to="/">
                                <div className="current-menu-item"  >
                                    <div className="flex items-center">
                                        ...
                                        <div className="side-menu-name" id="text" >Tableau de bord</div>
                                    </div>
                                </div>
                            </Link>
                        </li>
                        <li className="parc-informatique" id="text">
                            <Link to="/infrastructure">
                                <div className="current-menu-item" id="text">
                                    <div className="flex items-center">
                                        ...
                                        <div className="side-menu-name" id="text">Parc Informatique</div>
                                    </div>
                                </div>
                            </Link>
                            
                        </li>
                        <li className="statistiques @yield('statistiques')">
                            <Link to="/statistics">
                                <div className="current-menu-item">
                                    <div className="flex items-center">
                                        ...
                                        <p className="side-menu-name" id="text">Statistiques</p>
                                    </div>
                                </div>
                            </Link>
                        </li>
